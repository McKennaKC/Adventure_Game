...
#Code by: McKenna Caldwell (u0858285) and Marcellano Mascarenas (u0905990)
    ...
    while playing:
        ...
        if hero_rect.colliderect(monster_rect):
            ...
            if "sword" in inventory:
                ...
                dialog = "Come back when you are ready to fight me!"
            # These say where and for how long the dialog prints on the screen
            dialog_counter = 50
            dialog_position = (125, 450)
        ...
        if hero_rect.colliderect(sword_rect) and "coins" in inventory:
            inventory ["sword"] = True
            dialog = "Sword picked up!"
            dialog_counter = 30
            dialog_position = (250,450)
        else:
            if hero_rect.colliderect(sword_rect) and "coins" not in inventory:
                dialog = "You need coins!"
                dialog_counter = 30
                dialog_position = (250,450)
...
# Add 2nd level stuff
        ...
        if level_2 == True:
            ...
            if hero_rect.colliderect(sword_rect):
                inventory["sword"] = True
                dialog = "You picked up the sword!"
                dialog_counter = 30
                dialog_position = (250, 450)
